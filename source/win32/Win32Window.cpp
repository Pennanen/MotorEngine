...
namespace engine
{
	LRESULT WINAPI WindowProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
	{
		...
		/*case WM_KEYDOWN :
			...
			{
			case VK_UP:
				engine::inputmanager.setUpArrow(1);
				return 0;
			case VK_DOWN:
				engine::inputmanager.setDownArrow(1);
				return 0;
			case 'W':
				engine::inputmanager.setW(1); 
				return 0;
			case 'S':
				engine::inputmanager.setS(1);
				return 0;
			default:
				break;
			}
		...
		case WM_KEYUP:
			...
			{
			case VK_UP:
				engine::inputmanager.setUpArrow(0);
				return 0;
			case VK_DOWN:
				engine::inputmanager.setDownArrow(0);
				return 0;
			case 'W':
				engine::inputmanager.setW(0);
				return 0;
			case 'S':
				engine::inputmanager.setS(0);
				return 0;
			default:
				break;
			}
		...
		case WM_RBUTTONDOWN:
			...
			//engine::inputmanager.setMouseValues(ptClientLR.x, ptClientLR.y, engine::inputmanager.getMouseLButton(), 1);
		...
		case WM_LBUTTONDOWN:
			...
			//engine::inputmanager.setMouseValues(ptClientLR.x, ptClientLR.y, 1, engine::inputmanager.getMouseRButton());
			// Convert the cursor coordinates into a POINTS 
			// structure, which defines the beginning point of the 
			// line drawn during a WM_MOUSEMOVE message. 
		...
		case WM_LBUTTONUP:
			...
			ClipCursor(NULL);
			ReleaseCapture();
			//engine::inputmanager.setMouseValues(ptsEnd.x, ptsEnd.y, 0, engine::inputmanager.getMouseRButton());
			return 0;
		...
		case WM_RBUTTONUP:
			...
			ClipCursor(NULL);
			ReleaseCapture();
			//engine::inputmanager.setMouseValues(ptsEnd.x, ptsEnd.y, engine::inputmanager.getMouseLButton(), 0);
			return 0;
